  ...
  return (
    <main className="relative min-h-screen bg-white dark:bg-gray-900">
      ...
      <section className="relative min-h-screen bg-white dark:bg-gray-900 overflow-hidden">
        {/* Background Gradient */}
        <div className="absolute inset-0 bg-gradient-to-br from-purple-50 to-blue-50 dark:from-gray-900 dark:to-blue-900/5"></div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 min-h-screen flex items-center py-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative z-10 text-center lg:text-left">
              ...
              >
                ...
                <a 
                  ...
                  className="px-8 py-4 bg-white dark:bg-gray-800 border-2 border-purple-600 text-purple-600 dark:text-purple-300 hover:bg-purple-50 dark:hover:bg-gray-700 font-semibold rounded-lg shadow-sm hover:shadow transition-all duration-300 text-center"
                >
                  Book Consultation
                </a>
              </motion.div>
              ...
              >
                ...
                <div className="text-center sm:text-left">
                  <p className="text-sm text-gray-600 dark:text-gray-400">Join our community of</p>
            ...
            <motion.div 
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.5, delay: 0.2 }}
              className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg border border-gray-100 dark:border-gray-700/50"
            >
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={index} className="flex items-start space-x-4 p-4 bg-gray-50 dark:bg-gray-700/30 rounded-xl transition-all hover:bg-gray-100 dark:hover:bg-gray-700/50">
              ...
              <div className="mt-8 pt-6 border-t border-gray-100 dark:border-gray-700">
                <p className="text-center text-gray-600 dark:text-gray-400 mb-4">Connect with us</p>
                <div className="flex flex-wrap justify-center gap-3">
                  <a
                    href="https://t.me/Tegegnpathway"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center px-4 py-2 rounded-lg bg-purple-100 hover:bg-purple-200 dark:bg-purple-900/30 dark:hover:bg-purple-900/50 transition-colors text-purple-700 dark:text-purple-300 text-sm font-medium"
                  >
      ...
      <section className="py-20 bg-white dark:bg-gray-900">
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
          {[
            ...
            <div key={i} className="bg-white dark:bg-gray-800 text-indigo-600 dark:text-indigo-300 rounded-2xl shadow-md p-8 text-center flex flex-col items-center">
              {step.icon}
      ...
      <section className="py-20 bg-white dark:bg-gray-900">
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          {[1, 2, 3].map((n) => (
            <div key={n} className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 flex flex-col items-start hover:scale-105 transition">
              <h3 className="text-xl font-semibold mb-2 text-gray-900 dark:text-white">Scholarship Program {n}</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-4">Full scholarship for undergraduate students in STEM fields.</p>
      ...
      <section className="py-20 bg-white dark:bg-gray-900">
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          {[
            ...
            <div key={i} className="flex items-start gap-5 bg-white dark:bg-gray-800 rounded-2xl p-8 shadow hover:shadow-lg transition">
      ...
      <section className="py-20 bg-white dark:bg-gray-900">
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            <div key={i} className="bg-white dark:bg-gray-800 rounded-2xl shadow-md p-8">
              <p className="text-gray-700 dark:text-gray-300 italic mb-4">"{testimonial.text}"</p>
              <p className="font-medium text-purple-700 dark:text-purple-400">— {testimonial.name}</p>
            </div>
          ))}
        </div>
      </section>
  ...
  <div className="max-w-2xl mx-auto text-center">
    ...
    <form className="flex flex-col sm:flex-row gap-4 justify-center">
      <input
        ...
        className="px-6 py-3 rounded-full border border-purple-300 dark:border-purple-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-purple-400 outline-none w-full sm:w-auto"
      />
      <button
        type="submit"
